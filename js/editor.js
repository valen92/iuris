				...
				class:"row-fluid"
					...
					id:"tblForm"+idExtn 
						...
						class:"row" 
							...
							class:"col-xs-12 col-sm-6 col-md-6 col-lg-6"
							}).append($('<label/>',{ for:"tblAlign"+idExtn, text:"Alinear"}
							...
							).append($('<label/>',{	for:"tblBorder"+idExtn, text:"Borde"}
							)).append($('<input/>',{ 
								id:"tblBorder"+idExtn,
								type:"text",
								class:"form-control form-control-width",
								value:1
							})).append($('<label/>',{ for:"tblCellspacing"+idExtn,	text:"Separación"}
							)).append($('<input/>',{
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						   ...
						   'insert_link': { "modal": true,
											...
											"modalHeader": " Insertar hipervínculo",
								            	...
								            	class:"modal-dialog"
							            			...
							            			class:"modal-content"
									            		...
									            		class:"modal-footer"
								                			...
								                			type:"button",
								                			class:"btn btn-success",
								               				}).html('Elegir').mousedown(function(e){
								                			e.preventDefault();
