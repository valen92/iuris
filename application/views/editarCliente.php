...
<html lang="es-CO">
  ...
  <body>
    ...
    <div class="row">
      <div class="col s12">
        <h1>Nuevo Cliente</h1>
        <form method="post" name="tercero" id="tercero" action="<?php echo base_url(); ?>Welcome/editarCliente"><br>

          <!--Nombre-->
          <div class="row">
            <div class="input-field col s4">
              <i class="material-icons prefix">account_circle</i>
              <input type="text" id="nombre" name="nombre" value="<?php echo $datos->nombresTercero; ?>">
            ...
            <div class="input-field col s4">
              ...
              <input type="text" id="identificacion" name="identificacion" value="<?php echo $datos->identificacionTercero; ?>">
            </div>

            <!--PBX-->
            <div class="input-field col s4">
              <i class="material-icons prefix">phone_iphone</i>
              <input type="text" id="celular" name="celular" value="<?php echo $datos->celularTercero; ?>">
            ...
            <div class="input-field col s4">
              ...
              <input type="text" id="direccion" name="direccion" value="<?php echo $datos->direccionTercero; ?>">
            ...
            <div class="input-field col s4">
              ...
              <input type="text" id="correo" name="correo" value="<?php echo $datos->correoTercero; ?>">
              <label for="nombre">Correo:</label>
            </div>
          </div>
        </div>

        <input class="btn waves-effect waves-light" name="btnValidar" type="button" id="btnValidar"  value="Guardar" onclick="validarCliente()">
        <a href="<?php echo base_url(); ?>Welcome/clientes">
